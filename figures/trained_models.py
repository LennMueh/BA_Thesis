...
ax1.boxplot(df_trained['change_accuracy'].apply(list), showfliers=False)
ax1.set_title('Trained Models Delta Accuracy')
ax1.set_xlabel('Epoch')
ax1.set_ylabel('Change Accuracy')
ax1.grid()

ax2.boxplot(df_trained['change_loss'].apply(list), showfliers=False)
ax2.set_title('Trained Models Delta Loss')
ax2.set_xlabel('Epoch')
ax2.set_ylabel('Change Loss')
ax2.grid()

ax3.plot(df_trained.count(), label='Trained Models')
