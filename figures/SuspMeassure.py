...
df_not_trained = df[df.trained_between_iterations == False].groupby('approach_analysis')
df_trained = df[df.trained_between_iterations == True].groupby('approach_analysis')
...
plt.xlabel('Suspiciousness Meassure')
