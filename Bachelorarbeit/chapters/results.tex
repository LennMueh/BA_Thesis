...
We used 2 DNNs and 2 CNNs, in the following table \ref{tab:archi} a plain number describes the amount of neurons in a dense layer. $CL$ describes a combination of a convolutional layer with a stride of $(1,1)$ and a kernel size of $(3,3)$ and a pooling layer with a pool size of $(2,2)$.
We used Adam as our optimizer with a learning rate of 0.001.
