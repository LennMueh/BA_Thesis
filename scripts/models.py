...
if __name__ == '__main__':
    ...
    keras.saving.save_model(dnn_model1, "../models/dnn1_1epoch_full")
    ...
    keras.saving.save_model(dnn_model1, "../models/dnn1_6epoch_full")
    keras.saving.save_model(dnn_model1xv25_half, "../models/dnn1_6epoch_half")
    ...
    keras.saving.save_model(dnn_model2, "../models/dnn2_1epoch_full")
    ...
    keras.saving.save_model(dnn_model2, "../models/dnn2_6epoch_full")
    ...
    keras.saving.save_model(dnn_model3, "../models/dnn3_1epoch_full")
    ...
    keras.saving.save_model(dnn_model3, "../models/dnn3_6epoch_full")
    ...
    keras.saving.save_model(cnn_model1, "../models/cnn1_1epoch_full")
    ...
    keras.saving.save_model(cnn_model1, "../models/cnn1_6epoch_full")
    ...
    keras.saving.save_model(cnn_model2, "../models/cnn2_1epoch_full")
    ...
    keras.saving.save_model(cnn_model2, "../models/cnn2_6epoch_full")
