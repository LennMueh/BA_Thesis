...
select = ["tiny_vgg_1epoch_full"]
modelnames = [("tiny_vgg_1epoch_full", train_images, train_labels, test_images, test_labels),
              ("tiny_vgg_1epoch_quarter", train_images_quarter, train_labels_quarter, test_images, test_labels),
              ("tiny_vgg_6epoch_half", train_images_half, train_labels_half, test_images, test_labels),
              ("tiny_vgg_1epoch_half", train_images_half, train_labels_half, test_images, test_labels),
              ("tiny_vgg_6epoch_full", train_images, train_labels, test_images, test_labels),
              ("tiny_vgg_6epoch_quarter", train_images_quarter, train_labels_quarter, test_images, test_labels)]
#filter_models = [model for model in modelnames if sys.argv[1] in model[0]]
filter_models = [model for model in modelnames if model[0] in select]
analysis_approach = ["tarantula"]  # ["dstar","tarantula", "random", "ochiai"]
mutation_function = [utilities.modify_weight_one_random_gauss,
                     utilities.modify_weight_all_random_gauss,
...
regression_loss_offset = [False] #[True, False]
regression_accuracy_offset = [False] #[True, False]
